          ...
          <div className="relative aspect-[9/16] min-h-[32rem] w-full overflow-hidden bg-bg md:aspect-[16/9] md:min-h-[28rem]">
            ...
            {HOTSPOTS.map((spot) => (
              <button
                key={spot.id}
                type="button"
                onClick={(e) => openFrom(spot, e.currentTarget)}
      ...
      {selected && narrow
        ? createPortal(
            <>
              ...
              />
              <div className="fixed inset-x-0 bottom-0 z-50 border-t border-line bg-elevated px-4 pt-4 shadow-xl pb-[max(1.25rem,env(safe-area-inset-bottom))]">
